...
export default function HomePage() {
  return (
    <main className="bg-gray-800/50 border border-gray-700 p-8">
...
//   useEffect(() => {
//     const choice = localStorage.getItem("pursuit-journey");
//     setJourney(choice);
//   }, []);
...
// //   return (
// //     <div className="bg-gray-700 container mx-auto p-1">
